...
//
    thingShadows.register('FlexSensor', function () {
...
// Thing shadow state
//
        var flexSensorState = {"state": {"desired": {"angle": angleVal}}};

        clientTokenUpdate = thingShadows.update('FlexSensor', flexSensorState);
//
