...
In order to be able to understand what a cloud based IoT platform is, it is necessary to understand the difference between a platform and a service, as these terms seem to be used frequently for this topic.
...
Apart from the big and popular IoT platforms investigated above, a lot of different more "lightweight" IoT services exist, and some even effortlessly integrate with one another. Below, some are mentioned, and what they offer.
...
%Hvad er det der rent faktisk tilbydes. Platform? Service? Domænespecifikt?
